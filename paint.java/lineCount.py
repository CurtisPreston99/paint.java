...
f.write(str(totalCommentLineCount)+","+str(lineCount - totalBlankLineCount - totalCommentLineCount)+","+datetime.datetime.today().strftime('%Y-%m-%d')+"\n")
